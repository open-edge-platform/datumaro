...
def test_pytorch_schema_creation():
    ...
    attributes = {
        "image": AttributeInfo(type=torch.Tensor, annotation=image_field(dtype=pl.UInt8, format="RGB")),
        "bbox": AttributeInfo(type=torch.Tensor, annotation=bbox_field(dtype=pl.Float32, normalize=False)),
    }
