...
* ADE20k (v2017) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/ade20k2017_dataset>`_
...
* ADE20k (v2020) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/ade20k2020_dataset>`_
...
* Align CelebA (``classification``, ``landmarks``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/align_celeba_dataset>`_
...
* BraTS (``segmentation``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/brats_dataset>`_
   * `Format documentation <brats.md>`_
* BraTS Numpy (``detection``, ``segmentation``) (import-only)
   * `Format specification <https://www.med.upenn.edu/sbia/brats2018/data.html>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/brats_numpy_dataset>`_
   * `Format documentation <brats_numpy.md>`_
* CamVid (``segmentation``)
   * `Format specification <http://mi.eng.cam.ac.uk/research/projects/VideoRec/CamVid>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/camvid_dataset>`_
* CelebA (``classification``, ``detection``, ``landmarks``) (import-only)
   * `Format specification <https://mmlab.ie.cuhk.edu.hk/projects/CelebA.html>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/celeba_dataset>`_
   * `Format documentation <celeba.md>`_
* CIFAR-10/100 (``classification``)
   * `Format specification <https://www.cs.toronto.edu/~kriz/cifar.html>`_
   * `Dataset example CIFAR-10 <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/cifar10_dataset>`_
   * `Dataset example CIFAR-100 <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/cifar100_dataset>`_
   * `Format documentation <cifar.md>`_
* Cityscapes (``segmentation``)
   * `Format specification <https://www.cityscapes-dataset.com/dataset-overview/>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/cityscapes_dataset>`_
...
* Common Semantic Segmentation (``segmentation``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/common_semantic_segmentation_dataset>`_
   * `Format documentation <common_semantic_segmentation.md>`_
* Common Super Resolution
   * `Format specification <https://github.com/openvinotoolkit/open_model_zoo/blob/master/tools/accuracy_checker/openvino/tools/accuracy_checker/annotation_converters/README.md>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/common_super_resolution_dataset>`_
...
* CVAT (`for images`, `for video` (import-only))
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/cvat_dataset>`_
   * `Format documentation <cvat.md>`_
* DOTA (``detection_rotated``)
   * `Format specification <https://captain-whu.github.io/DOTA/dataset.html>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/dota_dataset>`_
...
* ICDAR13/15 (``word recognition``, ``text localization``, ``text segmentation``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/icdar_dataset>`_
* ImageNet (``classification``, ``detection``)
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/imagenet_dataset>`_
   * `Dataset example (txt for classification) <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/imagenet_txt_dataset>`_
...
* Kaggle (``classification``, ``detection``, ``segmentation``) (import-only)
   * `Dataset examples <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/kaggle_datasets>`_
...
* KITTI (``segmentation``, ``detection``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/kitti_dataset>`_
...
* KITTI 3D (``raw``, ``tracklets``, ``velodyne points``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/kitti_dataset/kitti_raw>`_
   * `Format documentation <kitti_raw.md>`_
* Kinetics 400/600/700
   * `Format specification <https://www.deepmind.com/open-source/kinetics>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/kinetics_dataset>`_
   * `Format documentation <kinetics.md>`_
* LabelMe (``labels``, ``boxes``, ``masks``)
   * `Format specification <http://labelme.csail.mit.edu/Release3.0>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/labelme_dataset>`_
...
* LFW (``classification``, ``person re-identification``, ``landmarks``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/lfw_dataset>`_
...
* Mapillary Vistas (``segmentation``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mapillary_vistas_dataset>`_
...
* Market-1501 (``person re-identification``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/market1501_dataset>`_
* MARS (import-only)
   * `Format specification <https://zheng-lab.cecs.anu.edu.au/Project/project_mars.html>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mars_dataset>`_
...
* MMDet-COCO (``detection``, ``segmentation``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/coco_dataset/mmdet_coco>`_
   * `Format documentation <mmdet.md>`_
* MNIST (``classification``)
   * `Format specification <http://yann.lecun.com/exdb/mnist/>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mnist_dataset>`_
...
* MNIST in CSV (``classification``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mnist_csv_dataset>`_
   * `Format documentation <mnist.md>`_
* MOT sequences
   * `Format specification <https://arxiv.org/pdf/1906.04567.pdf>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mot_dataset>`_
   * `Format documentation <mot.md>`_
* MOTS (png)
   * `Format specification <https://www.vision.rwth-aachen.de/page/mots>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mots_dataset>`_
...
* MPII Human Pose (``detection``, ``pose estimation``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mpii_dataset>`_
   * `Format documentation <mpii.md>`_
* MPII Human Pose JSON (``detection``, ``pose estimation``) (import-only)
   * `Format specification <http://human-pose.mpi-inf.mpg.de>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/mpii_json_dataset>`_
...
* MS COCO (``image info``, ``instances``, ``person keypoints``, ``captions``, ``labels``, ``panoptic``, ``stuff``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/coco_dataset>`_
   * ``labels`` are our extension - like `instances` with only `category_id`
   * `Format documentation <coco.md>`_
* Roboflow (import-only)
   * `Format specification <https://roboflow.com/formats/>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/roboflow_dataset>`_
...
* NYU Depth Dataset V2 (``depth estimation``) (import-only)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/nyu_depth_v2_dataset>`_
...
* OpenImages (``classification``, ``detection``, ``segmentation``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/open_images_dataset>`_
...
* PASCAL VOC (``classification``, ``detection``, ``segmentation``, ``action classification``, ``person layout``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/voc_dataset>`_
...
* Segment Anything (a.k.a SA-1B) (``detection``, ``segmentation``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/segment_anything_dataset>`_
...
* Supervisely (``pointcloud``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/sly_pointcloud_dataset>`_
   * `Format documentation <sly_pointcloud.md>`_
* SYNTHIA (``segmentation``) (import-only)
   * `Format specification <https://synthia-dataset.net/>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/synthia_dataset>`_
   * `Format documentation <synthia.md>`_
* Tabular (``classification``, ``regression``) (import/export only)
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/tabular_dataset/adopt-a-buddy>`_
...
* TF Detection API (``bboxes``, ``masks``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/tf_detection_api_dataset>`_
* VGGFace2 (``landmarks``, ``bboxes``)
   * `Format specification <https://github.com/ox-vgg/vgg_face2>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/vgg_face2_dataset>`_
   * `Format documentation <vgg_face2.md>`_
* VoTT CSV (``detection``) (import-only)
   * `Format specification <https://github.com/microsoft/VoTT>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/vott_csv_dataset>`_
   * `Format documentation <vott_csv.md>`_
* VoTT JSON (``detection``) (import-only)
   * `Format specification <https://github.com/microsoft/VoTT>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/vott_json_dataset>`_
   * `Format documentation <vott_json.md>`_
* WIDERFace (``bboxes``)
   * `Format specification <http://shuoyang1213.me/WIDERFACE/>`_
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/widerface_dataset>`_
...
* YOLO (``bboxes``)
   ...
   * `Dataset example <https://github.com/open-edge-platform/datumaro/tree/develop/tests/assets/yolo_dataset>`_
